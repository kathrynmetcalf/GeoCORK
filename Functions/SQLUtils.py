...
qsample_id_ifnull = 'GROUP_CONCAT(DISTINCT ifnull(SampleID,"Null"))'
...
qcolumn_lat_dir_ifnull = 'GROUP_CONCAT(DISTINCT ifnull(ColumnLatDirections.DirectionUnitName, "Null"))'
