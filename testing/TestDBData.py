...
def add_data(db_file):
    ...
    with conn:
        ...
        c.execute('INSERT INTO Units (UnitName, UnitDescription) VALUES ("Tso-Jiangding Group", "Upper Xigaze forearc")')
        c.execute('''INSERT INTO Units (ParentUnitID, UnitName, UnitDescription) 
                        VALUES (5, "Padana Formation", "Basal Tso-Jiangding Group")''')
        c.execute('''INSERT INTO Units (ParentUnitID, UnitName, UnitDescription) 
                        VALUES (5, "Qubeiya Formation", "Middle Tso-Jiangding Group")''')
        c.execute('''INSERT INTO Units (ParentUnitID, UnitName, UnitDescription) 
                        VALUES (5, "Quxia Formation", "Upper Tso-Jiangding Group")''')
        c.execute('''INSERT INTO Units (ParentUnitID, UnitName, UnitDescription) 
                        VALUES (5, "Jialazi Formation", "Upper Tso-Jiangding Group")''')
