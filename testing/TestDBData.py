...
def add_data(db_file):
    ...
    query.exec('''INSERT INTO Samples (SampleName, SampleGPSLocationID, SampleDescription) VALUES ("S1", 1, "Sample 3")''')
    query.exec('''INSERT INTO Samples (SampleName, SampleGPSLocationID, SampleDescription) VALUES ("S2", 2, "Sample 2")''')
    query.exec('''INSERT INTO Samples (SampleName, SampleGPSLocationID, SampleDescription) VALUES ("S3", 3, "Sample 1")''')
