...
from PyQt6.QtCore import Qt, QMargins, QPoint, QRect, QSize, pyqtSignal
from PyQt6.QtWidgets import QApplication, QLayout, QPushButton, QSizePolicy, QWidget, QVBoxLayout, QTabWidget, QLabel
...
if __name__ == '__main__':
    import sys
    from PyQt6.QtWidgets import QApplication, QPushButton, QScrollArea, QVBoxLayout, QWidget, QGroupBox
    ...
    for i in range(5):
        ...
        flowlayout.setObjectName(u"grid_layout_main_info")
        tab.setLayout(flowlayout)
